...
public interface CommitView extends View<CommitView.ActionDelegate> {
    ...
    /** Returns true if the project explorer selection must be added to index before commit. */
     ...
     *         <code>true</code> need to add selected files before commit, <code>false</code> otherwise
     */
